        ...
        try {
            ...
            if (response.ok) {
                ...
                const r = await fetch('http://localhost:5000/new_usc_ballot_candidate', {
                    ...
                    body: JSON.stringify({
                        usc_candidate_id: data.candidate_id,
                        usc_candidate_first_name: candidate_first_name,
                        usc_candidate_middle_name: candidate_middle_name,
                        usc_candidate_last_name: candidate_last_name,
                        usc_candidate_position: candidate_position,
                        usc_candidate_party: candidate_party,
                        usc_ballot_election_year: candidate_election_year,
                        usc_candidate_photo: candidate_photo,
